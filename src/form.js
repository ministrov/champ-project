...
// /**
//  * Удаляет все существующие сообщения об ошибках
//  */
...
//     clearAllErrors();
//     console.log('Форма успешно отправлена и сброшена');
//   })
//   .catch(error => {
...
//   // Дополнительная валидация email (формат)
...
//     console.warn('Не все поля формы найдены');
//     return;
//   }
